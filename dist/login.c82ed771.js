...
})({"ldzrQ":[function(require,module,exports) {
...
btn.addEventListener("click", async function() {
    if (codigo.value !== "" && correo.value !== "" && contrasena.value !== "") {
        if (codigo.value == 0) try {
            ...
            if (encontrado) {
                if (encontrado.contrasena === contrasena.value) dialog1.showModal();
                else dialog2.showModal();
            } else dialog3.showModal();
        } catch (error) {
            ...
            if (encontrado) {
                if (encontrado.contrasena === contrasena.value) dialog5.showModal();
                else dialog6.showModal();
            } else dialog7.showModal();
        } catch (error) {
            console.error("Error al obtener usuarios:", error);
            dialog8.showModal();
        }
        else dialog9.showModal();
    } else dialog10.showModal();
});
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"8JPHY"}],"8JPHY":[function(require,module,exports) {
...
},{}]},["ldzrQ","lgyI9"], "lgyI9", "parcelRequire1c86")
