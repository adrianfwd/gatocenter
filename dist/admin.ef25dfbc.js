...
btn_admi.addEventListener("click", function() {
    (0, _postJs.addAdmi)(nombre_admi.value, apellidos_admi.value, correo_admi.value, contrasena_admi.value);
});
...
const addAdmi = async (nombre_admi, apellidos_admi, correo_admi, contrasena_admi)=>{
    try {
